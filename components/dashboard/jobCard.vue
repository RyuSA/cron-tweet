      ...
      jobs: [
        {
          name: "動画広告ツイート",
          schedule: {
            type: this.$store.state.enum.SCHEDULED_EVERYWEEK.display_name_ja,
        ...
        },
        {
          name: "プラベ募集",
          schedule: {
            type: this.$store.state.enum.SCHEDULED_EVERYDAY.display_name_ja
          },
          exec_time: "10:00",
        ...
        },
        {
          name: "イベント告知用",
          schedule: {
            type: this.$store.state.enum.SCHEDULED_ONCE.display_name_ja
          },
          exec_time: "10:00",
          updated_at: "2019-01-01 11:00:00",
          created_at: "2019-01-01 10:00:00",
